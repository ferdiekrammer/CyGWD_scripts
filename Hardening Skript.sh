...
BANNER=$(cat << 'EOF'
 ...
 _   _       _ _       _____ ___________ _   _
| | | |     | | |     |  _  |  ___| ___ \ | | |
| |_| | __ _| | |_    | | | | |__ | |_/ / |_| |
|  _  |/ _` | | __|   | | | |  __|| ___ \  _  |
| | | | (_| | | |_ _  \ \_/ / |___| |_/ / | | |
\_| |_/\__,_|_|\__( )  \___/\____/\____/\_| |_/
                  |/
                                                                                                                                                                                                                                          

Wir muessen eine Personenkontrolle durchführen
Haben sie spitze Gegenstaende dabei die Sie oder mich gefährend könnten!?
...
services=(
    ...
    squid apache2 nginx telnetd postfix
...
run_command "ufw allow from 10.2.1.254 to any port 22" "SSH erlauben"
run_command "ufw allow from 10.2.1.254 to any port 3389" "RDP erlauben"
...
run_command 'chmod 660 /etc/systemd/system/*.timer' "Timers permissions fix"
